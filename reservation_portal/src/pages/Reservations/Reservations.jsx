                    ...
                    <div className='row'>
                        <div className='col1'>
                            <div className='rounded shadow'>
                                <div className='card'>
                                    <img className='img-profile-bg' src={assets.profile_bg} alt="" />
                                </div>
