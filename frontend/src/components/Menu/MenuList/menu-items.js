export const items = [
    ...
    {
        'name':'Chicken Nilgiri (leicht scharf)',
    ...
    {
        'name':'Lamb Vindaloo (sehr scharf)',
    ...
    {
        'name':'Palak Gosht (leicht scharf)',
    ...
    {
        'name':'Duck Vindaloo (sehr scharf)',
    ...
    {
        'name':'Fisch Curry (leicht scharf)',
    ...
    {
        'name':'Fisch Nilgiri (leicht scharf)',
    ...
    {
        'name': 'Taste of India Special (leicht scharf)',
    ...
    {
        'name': 'Gemischter Vorspeisenteller mit Fleisch',
    ...
    {
        'name':'Hausgemachte Gulab Jamun',
        'description': 'Milchpulverkugeln mit süßem Zuckersirup',
        'price': '6,90',
        'category': 'dessert'
    },    
    {
        'name':'Hausgemachte Gulab Jamun Mango',
    ...
    {
        'name':'Hausgemachtes Eis mit Sahne',
